...
* <SIGNATURE>---------------------------------------------------------------------------------------+
* | Instance Public Method ZCL_APC_WSP_EXT_Z_EEZZ_WS_PUSH->IF_APC_WSP_EXTENSION~ON_MESSAGE
* +-------------------------------------------------------------------------------------------------+
...
* <SIGNATURE>---------------------------------------------------------------------------------------+
* | Instance Public Method ZCL_APC_WSP_EXT_Z_EEZZ_WS_PUSH->IF_APC_WSP_EXTENSION~ON_START
* +-------------------------------------------------------------------------------------------------+
* | [--->] I_CONTEXT                      TYPE REF TO IF_APC_WSP_SERVER_CONTEXT
* | [--->] I_MESSAGE_MANAGER              TYPE REF TO IF_APC_WSP_MESSAGE_MANAGER
* +--------------------------------------------------------------------------------------</SIGNATURE>
...
* <SIGNATURE>---------------------------------------------------------------------------------------+
* | Instance Public Method ZCL_APC_WSP_EXT_Z_EEZZ_WS_PUSH->IF_APC_WS_BINDING_MANAGER~BIND_AMC_MESSAGE_CONSUMER
* +-------------------------------------------------------------------------------------------------+
* | [--->] I_APPLICATION_ID               TYPE        AMC_APPLICATION_ID
* | [--->] I_CHANNEL_ID                   TYPE        AMC_CHANNEL_ID
* | [--->] I_CHANNEL_EXTENSION_ID         TYPE        AMC_CHANNEL_EXTENSION_ID(optional)
* | [!CX!] CX_APC_ERROR
* +--------------------------------------------------------------------------------------</SIGNATURE>
...
* <SIGNATURE>---------------------------------------------------------------------------------------+
* | Instance Public Method ZCL_APC_WSP_EXT_Z_EEZZ_WS_PUSH->IF_APC_WS_BINDING_MANAGER~UNBIND_AMC_MESSAGE_CONSUMER
* +-------------------------------------------------------------------------------------------------+
* | [--->] I_APPLICATION_ID               TYPE        AMC_APPLICATION_ID
* | [--->] I_CHANNEL_ID                   TYPE        AMC_CHANNEL_ID
* | [--->] I_CHANNEL_EXTENSION_ID         TYPE        AMC_CHANNEL_EXTENSION_ID(optional)
