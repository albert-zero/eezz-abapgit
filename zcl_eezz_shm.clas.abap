...
public section.
  ...
  constants AREA_NAME type SHM_AREA_NAME value 'ZCL_EEZZ_SHM' ##NO_TEXT.
  data ROOT type ref to ZCL_EEZZ_DRIVE read-only .
  ...
  class-methods ATTACH_FOR_READ
    ...
    returning
      value(HANDLE) type ref to ZCL_EEZZ_SHM
    raising
      CX_SHM_INCONSISTENT
  ...
  methods SET_ROOT
    importing
      !ROOT type ref to ZCL_EEZZ_DRIVE
    raising
...
CLASS ZCL_EEZZ_SHM IMPLEMENTATION.
